...
- An exploratory density-matrix feature space, built directly from the multichannel analytic signal, reached mean balanced accuracy [0.657]{.num-chip} and ROC AUC [0.780]{.num-chip} under matched 10-fold × 10 cross-validation; the best classical-QEEG classifier on the same children reached [0.618]{.num-chip} / [0.615]{.num-chip}.
